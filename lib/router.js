...
if(Meteor.isClient){
  ...
  Router.after(filters.resetScroll, {except:['posts_top', 'posts_new','posts_old', 'posts_best', 'posts_pending', 'posts_category', 'all-users']});
...
PostsListController = FastRender.RouteController.extend({
  ...
  waitOn: function () {
    ...
    this._terms = {
      ...
      limit: this.params.limit || getSetting('postsPerPage', 20),
  ...
  data: function () {
    ...
    console.log("psk: "+this._terms.limit + "  "+posts.count );
